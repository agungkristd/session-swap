...
export function createSessionItem(
  ...
  // User Requested: text-sm
  nameSpan.className = `session-name text-sm select-none truncate ${nameClasses}`;
  ...
  dateSpan.className = "text-[11px] text-neutral-500 select-none truncate";
  ...
  renameBtn.className =
    "rename-btn p-1 text-neutral-500 hover:text-blue-800 hover:bg-blue-100 dark:hover:bg-neutral-800 rounded-md transition-all z-10 relative cursor-pointer";
  ...
  deleteBtn.className =
    "delete-btn p-1 text-neutral-500 hover:text-red-800 hover:bg-red-100 dark:hover:bg-red-900/20 rounded-md transition-all z-10 relative cursor-pointer";
  ...
  innerContainer.className =
    "flex items-center w-full cursor-pointer rounded-md";
